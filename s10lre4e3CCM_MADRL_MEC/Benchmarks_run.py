...
def run(InfdexofResult):
    ...
    Benchmarks_modes = ["MADDPG"] #["deadline_divide2_size_first_MADDPG", "offloadtimefirst_MADDPG", "MADDPG", "mindeadlinefirst_MADDPG",  "maxdeadlinefirst_MADDPG",  "minsizefirst_MADDPG", "maxsizefirst_MADDPG"]
