...
class CriticNetwork(nn.Module):
    ...
    def __init__(self, state_dim, action_dim, pestate, peraction, output_size=1, init_w =3e-3):
        ...
        self.fc1 = nn.Linear(state_dim + action_dim + pestate + peraction , 512) # state_dim + action_dim = for the combined, equivalent of it for the per agent, and 1 for distinguisher
